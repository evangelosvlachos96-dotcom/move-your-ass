        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuspendedAtUtc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
                    ...
                    ActiveSessionStartedAtUtc = table.Column<DateTime>(type: "datetime2(3)", nullable: true),
                    ActiveSessionUserAgent = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AspNetUsers_Status", "[Status] IN (0, 1, 2)");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResponseJson = table.Column<string>(type: "nvarchar(max)", maxLength: -1, nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2(3)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastError = table.Column<string>(type: "nvarchar(max)", maxLength: -1, nullable: true),
